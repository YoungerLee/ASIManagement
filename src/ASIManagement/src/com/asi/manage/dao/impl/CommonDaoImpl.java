...
import com.asi.manage.dao.CommonDao;
...
public class CommonDaoImpl<T> extends HibernateDaoSupport implements
	...
	/** 指定查询条件，查询列表 */
	/**
	 * SELECT * FROM elec_text o WHERE 1=1 #Dao层 AND o.textName LIKE '%张%'
	 * #Service层 AND o.textRemark LIKE '%张%' #Service层 ORDER BY o.textDate
	 * ASC,o.textName DESC #Service层
	 */
	...
	/**
	 * 将Map集合中存放的字段排序，组织成 ORDER BY o.textDate ASC,o.textName DESC
	 */
